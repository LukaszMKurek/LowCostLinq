...
namespace LowCostLinq
{
    ...
    public readonly struct LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut> : IEnumerable<TOut>
        ...
        where TFilter3 : struct, IFilter<TM2, TOut>
    {
        ...
        internal LowCostLinq(in TCollectionWrapper collection, in TFilter1 filter1, in TFilter2 filter2, in TFilter3 filter3)
        {
        ...
        public struct Enumerator : IEnumerator<TOut>
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            internal Enumerator(in TCollectionWrapper collection, in TFilter1 filter1, in TFilter2 filter2, in TFilter3 filter3)
            {
        ...
        public LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, Where<TOut>, TOut> Where(Func<TOut, bool> @where)
        {
            ...
            var filter4 = new Where<TOut>(@where);
            return new LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, Where<TOut>, TOut>(_collection, _filter1, _filter2, _filter3, filter4);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, WhereParam<TParam, TOut>, TOut> Where<TParam>(TParam param, Func<TParam, TOut, bool> @where)
        {
            if (@where == null) ThrowHelper.WhereDelegateIsNull();

            var filter4 = new WhereParam<TParam, TOut>(param, @where);
            return new LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, WhereParam<TParam, TOut>, TOut>(_collection, _filter1, _filter2, _filter3, filter4);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, Select<TOut, TOutNext>, TOutNext> Select<TOutNext>(Func<TOut, TOutNext> @select)
        {
            if (@select == null) ThrowHelper.SelectDelegateIsNull();

            var filter4 = new Select<TOut, TOutNext>(@select);
            return new LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, Select<TOut, TOutNext>, TOutNext>(_collection, _filter1, _filter2, _filter3, filter4);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, TFilter, TOut> Where<TFilter>(in TFilter filter)
            where TFilter : struct, IFilter<TOut, TOut>
        {
            return new LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, TFilter, TOut>(_collection, _filter1, _filter2, _filter3, filter);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, TFilter, TOutNext> Filter<TOutNext, TFilter>(in TFilter filter)
            where TFilter : struct, IFilter<TOut, TOutNext>
        {
            return new LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, TFilter, TOutNext>(_collection, _filter1, _filter2, _filter3, filter);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, TakeN<TOut>, TOut> Take(int n)
        {
            return new LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, TakeN<TOut>, TOut>(_collection, _filter1, _filter2, _filter3, new TakeN<TOut>(n));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, TakeWhile<TOut>, TOut> TakeWhile(Func<TOut, bool> @while)
        {
            if (@while == null) ThrowHelper.TakeWhileDelegateIsNull();

            return new LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, TakeWhile<TOut>, TOut>(_collection, _filter1, _filter2, _filter3, new TakeWhile<TOut>(@while));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, SkipN<TOut>, TOut> Skip(int n)
        {
            return new LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, SkipN<TOut>, TOut>(_collection, _filter1, _filter2, _filter3, new SkipN<TOut>(n));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, SkipWhile<TOut>, TOut> SkipWhile(Func<TOut, bool> @while)
        {
            if (@while == null) ThrowHelper.SkipWhileDelegateIsNull();

            return new LowCostLinq<TIn, TCollectionWrapper, TCollectionIterator, TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, SkipWhile<TOut>, TOut>(_collection, _filter1, _filter2, _filter3, new SkipWhile<TOut>(@while));
        }
        ...
        public int Count()
        {
            ...
            _collection.Iterate<TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, CountAccumulator<TOut>>(_filter1, _filter2, _filter3, ref acc);
            return acc.Count;
        }
        ...
        public int Count(Func<TOut, bool> @where)
        {
            ...
            _collection.Iterate<TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, CountWhereAccumulator<TOut>>(_filter1, _filter2, _filter3, ref acc);
        ...
        public TOut Single()
        {
            ...
            _collection.Iterate<TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, SingleWithFlagAccumulator<TOut>>(_filter1, _filter2, _filter3, ref acc);
        ...
        public TOut Single(Func<TOut, bool> @where)
        {
            ...
            _collection.Iterate<TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, SingleWithFlagWhereAccumulator<TOut>>(_filter1, _filter2, _filter3, ref acc);
        ...
        public bool Any()
        {
            ...
            _collection.Iterate<TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, AnyAccumulator<TOut>>(_filter1, _filter2, _filter3, ref acc);
        ...
        public bool Any(Func<TOut, bool> @where)
        {
            ...
            _collection.Iterate<TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, AnyWhereAccumulator<TOut>>(_filter1, _filter2, _filter3, ref acc);
        ...
        public bool All(Func<TOut, bool> @where)
        {
            ...
            _collection.Iterate<TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, AllWhereAccumulator<TOut>>(_filter1, _filter2, _filter3, ref acc);
        ...
        public TOut[] ToArray()
        {
            ...
            _collection.Iterate<TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, ToArrayAccumulatorOptimizedForDefault<TOut>>(_filter1, _filter2, _filter3, ref acc);
        ...
        public TOut[] ToArray(uint expectedCapacity)
        {
            ...
            _collection.Iterate<TFilter1, TM1, TFilter2, TM2, TFilter3, TOut, ToArrayAccumulator<TOut>>(_filter1, _filter2, _filter3, ref acc);
